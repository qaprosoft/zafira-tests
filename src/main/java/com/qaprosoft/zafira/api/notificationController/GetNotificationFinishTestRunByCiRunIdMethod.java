...
public class GetNotificationFinishTestRunByCiRunIdMethod extends ZafiraBaseApiMethodWithAuth {

    public GetNotificationFinishTestRunByCiRunIdMethod(String ciRunId) {
