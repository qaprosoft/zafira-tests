...
@ResponseTemplatePath(path = "api/projectIntegrations/qtest/_get/rs.json")
@Endpoint(url = "${api_url}/v1/integrations/qtest?projectId=${projectId}&onlyActive=false&decryptValues=true",
        methodType = HttpMethodType.GET)
public class GetQTestIntegrationByProjectIdMethod extends AbstractApiMethodV2 {
    public GetQTestIntegrationByProjectIdMethod(int projectId) throws UnsupportedEncodingException {
