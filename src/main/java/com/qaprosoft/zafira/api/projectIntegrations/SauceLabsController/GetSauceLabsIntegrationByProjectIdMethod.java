...
@ResponseTemplatePath(path = "api/projectIntegrations/sauceLabs/_get/rs.json")
@Endpoint(url = "${api_url}/v1/integrations/sauce-labs?projectId=${projectId}&onlyActive=false&decryptValues=true",
        methodType = HttpMethodType.GET)
public class GetSauceLabsIntegrationByProjectIdMethod extends AbstractApiMethodV2 {
    public GetSauceLabsIntegrationByProjectIdMethod(int projectId) throws UnsupportedEncodingException {
